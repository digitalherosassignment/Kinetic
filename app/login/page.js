        ...
        <div className="w-full max-w-md">
          <div className="mb-12">
            ...
            <p className="text-on-surface-variant">
              Access your Kinetic dashboard and track your impact.
            </p>
          </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-surface flex items-center justify-center"><span className="font-headline font-black text-xl">KINETIC</span></div>}>
      <LoginForm />
    </Suspense>
  );
}
